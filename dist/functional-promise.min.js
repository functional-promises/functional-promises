...
/*! dynamic exports provided */
/*! all exports used */
function(t,n,r){function e(t){if(Array.isArray(t)){for(var n=0,r=Array(t.length);n<t.length;n++)r[n]=t[n];return r}return Array.from(t)}function o(){var t=r(/*! ./index */0),n=t.resolve();return n.steps=[],n}function i(){var t=this,n=r(/*! ./index */0);return function(r){if(!t.steps||t.steps.length<=0)throw new s("No steps defined between .chain() & .chainEnd()");var o=0,i=n.unpack(),c=i.promise,a=i.resolve;for(i.reject;o<t.steps.length;){var f,l=u(t.steps[o],3),p=l[0],h=l[2];c=(f=c)[p].apply(f,e(h)),o++}return a(r),c}}var u=function(){function t(t,n){var r=[],e=!0,o=!1,i=void 0;try{for(var u,c=t[Symbol.iterator]();!(e=(u=c.next()).done)&&(r.push(u.value),!n||r.length!==n);e=!0);}catch(t){o=!0,i=t}finally{try{!e&&c.return&&c.return()}finally{if(o)throw i}}return r}return function(n,r){if(Array.isArray(n))return n;if(Symbol.iterator in Object(n))return t(n,r);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),c=r(/*! ./modules/errors */1),s=c.FPInputError;t.exports={chain:o,chainEnd:i}},/*!***********************!*\
  !*** ./src/arrays.js ***!
  \***********************/
/*! dynamic exports provided */
/*! all exports used */
function(t,n,r){function e(t){if(Array.isArray(t)){for(var n=0,r=Array(t.length);n<t.length;n++)r[n]=t[n];return r}return Array.from(t)}function o(t){return u.call(this,t).then(function(t){return t.item})}function i(t){return u.call(this,t).then(function(t){return t.index})}function u(t,n){var e=r(/*! ./index */0);return this.steps?this.addStep("_find",[].concat(Array.prototype.slice.call(arguments))):("function"==typeof t&&(n=t,t=this._FP.promise),e.resolve(t).filter(n).then(function(t){return void 0!=t[0]?{item:t[0],index:t.indexOf(t[0])}:{item:void 0,index:-1}}))}function c(t,n){return this.steps?this.addStep("filter",[].concat(Array.prototype.slice.call(arguments))):("function"==typeof t&&(n=t,t=this._FP.promise),s(t,function(t,r){return Promise.resolve(n(r)).then(function(n){return n?t.concat([r]):t})},[]))}function s(t,n,e){var o=r(/*! ./index */0);return this.steps?this.addStep("reduce",[].concat(Array.prototype.slice.call(arguments))):("function"==typeof t?(e=n,n=t,t=this._FP?this._FP.promise:this):t=o.resolve(t,this),new o(function(r,o){return t.then(function(t){var i=t[Symbol.iterator](),u=0;!function t(e){var c=i.next();if(c.done)return r(e);Promise.all([e,c.value]).then(function(r){var e=f(r,2),o=e[0],i=e[1];return t(n(o,i,u++))}).catch(o)}(e)})}))}function a(t,n,o){var i=this,u=r(/*! ./index */0);if(this.steps)return this.addStep("map",[].concat(Array.prototype.slice.call(arguments)));1===arguments.length&&this&&this._FP&&(n=t,t=this&&this._FP&&this._FP.promise);var c=!1,s=Math.max(1,Math.min(this&&this._FP&&this._FP.concurrencyLimit||1,4)),a=this&&this._FP&&this._FP.promise?this._FP.promise:Promise.resolve(t),f=0,l=[],h=0,m=[],v=new Set,b=function(){return v.size>=s},g=function(){return l.length>i._FP.errors.limit||h>=t.length||c},P=function(t){return function(n){return v.delete(t),m[t]=n,n}};return u.resolve(new Promise(function(r,o){var u=function(t){if(c)return null;c=!0,r(t)},w=function(t){if(c)return null;c=!0,o(t)};a.then(function(r){if(t=[].concat(e(r)),!p(r))return o(new y("Invalid input data passed into FP.map()"));for(var a=function(){var t=null;return l.length>i._FP.errors.limit&&(t=w),g()&&(t=u),!!t&&(Promise.all(m).then(function(n){return t(m)}),!0)},_=function(t){if(!c)return a()||m[h]||F(h),t},F=function r(e){return c?null:(h++,b()?setTimeout(function(){return r(e)},0):m[e]?m[e]:(v.add(e),m[e]=Promise.resolve(t[e]).then(function(r){return n(r,e,t)}).then(function(t){return P(e)(t)}).then(_).catch(function(t){if(i._FP.errors.count++,l.push(t),!(l.length>i._FP.errors.limit))return Promise.resolve().then(function(){return P(e)(t)}).then(_);var n=1===l.length?t:new d("Error Limit "+i._FP.errors.limit+" Exceeded.\n              idx="+e+" errCnt="+i._FP.errors.count,{errors:l,results:m,ctx:i});Promise.resolve(P(e)(t)).then(function(){return w(n)})}),m[e]))};f<s&&f<t.length;)F(f++)})}))}var f=function(){function t(t,n){var r=[],e=!0,o=!1,i=void 0;try{for(var u,c=t[Symbol.iterator]();!(e=(u=c.next()).done)&&(r.push(u.value),!n||r.length!==n);e=!0);}catch(t){o=!0,i=t}finally{try{!e&&c.return&&c.return()}finally{if(o)throw i}}return r}return function(n,r){if(Array.isArray(n))return n;if(Symbol.iterator in Object(n))return t(n,r);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),l=r(/*! ./modules/utils */2),p=l.isEnumerable,h=r(/*! ./modules/errors */1),y=h.FPInputError,d=h.FunctionalError;t.exports={map:a,find:o,findIndex:i,filter:c,reduce:s}},/*!***********************!*\
  !*** ./src/events.js ***!
  \***********************/
/*! dynamic exports provided */
/*! all exports used */
...
return r(0).resolve(Array.isArray(t)?Promise.all(t):o(t))}function o(t){var n=Object.getOwnPropertyNames(t),r=n.map(function(n){return t[n]});return Promise.all(r).then(function(t){return t.reduce(function(t,r,e){var o,i=n[e];return Object.assign((o={},o[i]=r,o),t)},{})})}function i(t){if(t instanceof Error)return this&&(this._error=t),Promise.reject(t);throw new Error("Reject only accepts a new instance of Error!")}function u(t){var n=r(/*! ./ */0);if(!Number.isInteger(t))throw new a("FP.delay(millisec) requires a numeric arg.");return function(r){return new n(function(n){setTimeout(function(){return n(r)},t)})}}function c(t){var n=r(/*! ./ */0);return this.steps?this.addStep("delay",[].concat(Array.prototype.slice.call(arguments))):this&&this._FP?n.resolve(this.then(u(t))):u(t)()}var s=r(/*! ./modules/errors */1),a=s.FPInputError;t.exports={all:e,reject:i,delay:c,_delay:u}}]);