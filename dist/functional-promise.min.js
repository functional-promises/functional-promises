...
/*! all exports used */
function(t,n,r){(function(n){function e(t,n){if(!(this instanceof e))return new e(t);if(void 0!=n)throw new Error("FunctionalPromise only accepts 1 argument");this._FP={errors:{limit:1,count:0},promise:new Promise(t),concurrencyLimit:4}}var o="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},i=r(/*! ./modules/errors */1),u=i.FunctionalError,c=r(/*! ./modules/utils */2),s=c.isFunction,a=c.flatten,f=r(/*! ./monads */4),l=f.chain,h=f.chainEnd,p=e;Object.assign(p.prototype,r(/*! ./arrays */5),r(/*! ./events */6),r(/*! ./conditional */7),r(/*! ./promise */8)),p.all=p.prototype.all,p.thenIf=p.prototype._thenIf,p.delay=function(t){return p.resolve().delay(t)},p.chain=l,p.prototype.chainEnd=h,p.prototype.addStep=function(t,n){return this.steps&&this.steps.push([t,this,n]),this},p.prototype.concurrency=function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:1/0;return this.steps?this.addStep("concurrency",[].concat(Array.prototype.slice.call(arguments))):(this._FP.concurrencyLimit=t,this)},p.prototype.quiet=function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:1/0;return this.steps?this.addStep("quiet",[].concat(Array.prototype.slice.call(arguments))):(this._FP.errors={count:0,limit:t},this)},p.prototype.get=function(){for(var t=arguments.length,n=Array(t),r=0;r<t;r++)n[r]=arguments[r];return this.steps?this.addStep("get",[].concat(Array.prototype.slice.call(arguments))):(n=a(n),this.then(function(t){return"object"===(void 0===t?"undefined":o(t))?1===n.length?t[n[0]]:n.reduce(function(n,r){return n[r]=t[r],n},{}):t}))},p.prototype.set=function(t,n){return this.steps?this.addStep("set",[].concat(Array.prototype.slice.call(arguments))):this.then(function(r){return"object"===(void 0===r?"undefined":o(r))&&(r[t]=n),r})},p.prototype.catch=function(t){if(this.steps)return this.addStep("catch",[].concat(Array.prototype.slice.call(arguments)));if(2===arguments.length)return this.catchIf.apply(this,arguments);if(!s(t))throw new u("Invalid fn argument for `.catch(fn)`. Must be a function. Currently: "+(void 0===t?"undefined":o(t)));return p.resolve(this._FP.promise.catch(function(n){return t(n)}))},p.prototype.catchIf=function(t,n){if(this.steps)return this.addStep("catchIf",[].concat(Array.prototype.slice.call(arguments)));if(!s(n))throw new u("Invalid fn argument for `.catchIf(condition, fn)`. Must be a function. Currently: "+(void 0===n?"undefined":o(n)));return p.resolve(this._FP.promise.catch(function(r){if(t&&r instanceof t)return n(r);throw r}))},p.prototype.then=function(t){if(this.steps)return this.addStep("then",[].concat(Array.prototype.slice.call(arguments)));if(!s(t))throw new u("Invalid fn argument for `.then(fn)`. Must be a function. Currently: "+(void 0===t?"undefined":o(t)));return p.resolve(this._FP.promise.then(t))},p.prototype.tap=function(t){if(this.steps)return this.addStep("tap",[].concat(Array.prototype.slice.call(arguments)));if(!s(t))throw new u("Invalid fn argument for `.tap(fn)`. Must be a function. Currently: "+(void 0===t?"undefined":o(t)));return p.resolve(this._FP.promise.then(function(n){return t(n),n}))},p.resolve=p.prototype.resolve=function(t){return new p(function(n,r){if(t&&s(t.then))return t.then(n).catch(r);n(t)})},p.promisify=function(t){var n=this;return function(){for(var r=arguments.length,e=Array(r),o=0;o<r;o++)e[o]=arguments[o];return new p(function(r,o){return t.call.apply(t,[n].concat(e,[function(t,n){return t?o(t):r(n)}]))})}},p.promisifyAll=function(t){if(!t||!Object.getPrototypeOf(t))throw new Error("Invalid Argument obj in promisifyAll(obj)");return Object.getOwnPropertyNames(t).filter(function(n){return"function"==typeof t[n]}).reduce(function(t,n){return/Sync/.test(n)||t[n+"Async"]||(t[n+"Async"]=p.promisify(t[""+n])),t},t)},p.unpack=function(){var t=void 0,n=void 0,r=void 0;return r=new Promise(function(r,e){t=r,n=e}),{promise:r,resolve:t,reject:n}},t.exports=e,n&&n.on&&(n.on("uncaughtException",function(t){return console.error("Process: FATAL EXCEPTION: uncaughtException",t,"\n\n")}),n.on("unhandledRejection",function(t){return console.error("Process: FATAL PROMISE ERROR: unhandledRejection",t,"\n\n")}))}).call(n,r(/*! ./../node_modules/process/browser.js */3))},/*!*******************************!*\
...
/*! dynamic exports provided */
/*! all exports used */
function(t,n,r){function e(t){if(Array.isArray(t)){for(var n=0,r=Array(t.length);n<t.length;n++)r[n]=t[n];return r}return Array.from(t)}function o(t){return u.call(this,t).then(function(t){return t.item})}function i(t){return u.call(this,t).then(function(t){return t.index})}function u(t,n){var e=r(/*! ./index */0);return this.steps?this.addStep("_find",[].concat(Array.prototype.slice.call(arguments))):("function"==typeof t&&(n=t,t=this._FP.promise),e.resolve(t).filter(n).then(function(t){return t&&t[0]?{item:t[0],index:t.indexOf(t[0])}:{item:void 0,index:-1}}))}function c(t,n){return this.steps?this.addStep("filter",[].concat(Array.prototype.slice.call(arguments))):("function"==typeof t&&(n=t,t=this._FP.promise),s(t,function(t,r){return Promise.resolve(n(r)).then(function(n){return n?t.concat([r]):t})},[]))}function s(t,n,e){var o=r(/*! ./index */0);return this.steps?this.addStep("reduce",[].concat(Array.prototype.slice.call(arguments))):("function"==typeof t?(e=n,n=t,t=this._FP?this._FP.promise:this):t=o.resolve(t,this),new o(function(r,o){return t.then(function(t){var i=t[Symbol.iterator](),u=0;!function t(e){var c=i.next();if(c.done)return r(e);Promise.all([e,c.value]).then(function(r){var e=f(r,2),o=e[0],i=e[1];return t(n(o,i,u++))}).catch(o)}(e)})}))}function a(t,n,o){var i=this,u=r(/*! ./index */0);if(this.steps)return this.addStep("map",[].concat(Array.prototype.slice.call(arguments)));1===arguments.length&&this&&this._FP&&(n=t,t=this&&this._FP&&this._FP.promise);var c=!1,s=Math.max(1,Math.min(this&&this._FP&&this._FP.concurrencyLimit||1,4)),a=this&&this._FP&&this._FP.promise?this._FP.promise:Promise.resolve(t),f=0,l=[],p=0,m=[],v=new Set,P=function(){return v.size>=s},b=function(){return p>=t.length||c||l.length>i._FP.errors.limit},g=function(t){return function(n){return v.delete(t),m[t]=n,n}};return new u(function(r,o){var u=function(t){if(c)return null;c=!0,r(t)},w=function(t){if(c)return null;c=!0,o(t)};a.then(function(r){if(t=[].concat(e(r)),!h(r))return o(new y("Invalid input data passed into FP.map()"));for(var a=function(){var t=null;return l.length>i._FP.errors.limit&&(t=w),b()&&(t=u),!!t&&(Promise.all(m).then(function(n){return t(m)}),!0)},_=function(t){if(!c)return a()||m[p]||E(p),t},E=function r(e){return c?null:(p++,P()?setTimeout(function(){return r(e)},0):m[e]?m[e]:(v.add(e),m[e]=Promise.resolve(t[e]).then(function(r){return n(r,e,t)}).then(function(t){return g(e)(t)}).then(_).catch(function(t){if(i._FP.errors.count++,l.push(t),!(l.length>i._FP.errors.limit))return Promise.resolve().then(function(){return g(e)(t)}).then(_);var n=1===l.length?t:new d("Error Limit "+i._FP.errors.limit+" Exceeded. CurrentArrayIndex="+e+" ActualNumberOfErrors="+i._FP.errors.count,{errors:l,results:m,ctx:i});Promise.resolve(g(e)(t)).then(function(){w(n)})}),m[e]))};f<s&&f<t.length;)E(f++)})})}var f=function(){function t(t,n){var r=[],e=!0,o=!1,i=void 0;try{for(var u,c=t[Symbol.iterator]();!(e=(u=c.next()).done)&&(r.push(u.value),!n||r.length!==n);e=!0);}catch(t){o=!0,i=t}finally{try{!e&&c.return&&c.return()}finally{if(o)throw i}}return r}return function(n,r){if(Array.isArray(n))return n;if(Symbol.iterator in Object(n))return t(n,r);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),l=r(/*! ./modules/utils */2),h=l.isEnumerable,p=r(/*! ./modules/errors */1),y=p.FPInputError,d=p.FunctionalError;t.exports={map:a,find:o,findIndex:i,filter:c,reduce:s}},/*!***********************!*\
  !*** ./src/events.js ***!
  \***********************/
/*! dynamic exports provided */
/*! all exports used */
function(t,n,r){var e=r(/*! ./modules/errors */1),o=e.FPInputError;t.exports={listen:function(t){for(var n=this,r=arguments.length,e=Array(r>1?r-1:0),i=1;i<r;i++)e[i-1]=arguments[i];if("string"==typeof e&&(e=[e]),!t[t.addEventListener?"addEventListener":"on"])throw new o("Valid EventEmitter required.");var u=this.chainEnd();return this._FP.destroy=function(){return n._FP.destroyHandles.map(function(t){return t()||!0}).filter(function(t){return t}).length},this._FP.destroyHandles=e.map(function(n){return t[t.addEventListener?"addEventListener":"on"](n,u),function(){return t[t.removeEventListener?"removeEventListener":"off"](n,u)}}),this}}},/*!****************************!*\
  !*** ./src/conditional.js ***!
  \****************************/
/*! dynamic exports provided */
/*! all exports used */
