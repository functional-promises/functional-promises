...
/*! all exports used */
function(t,n,r){(function(n){function e(t,n){if(!(this instanceof e))return new e(t);if(void 0!=n)throw new Error("FunctionalPromise only accepts 1 argument");this._FP={concurrencyLimit:4,promise:new Promise(t)}}var o="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},i=r(/*! ./modules/errors */1),u=i.FunctionalError,c=r(/*! ./modules/utils */2),s=c.isFunction,a=c.flatten,f=r(/*! ./arrays */3),l=f.map,p=f.filter,h=f.reduce,y=r(/*! ./arrays */3),d=y.find,m=y.findIndex,v=r(/*! ./conditional */5),b=v.thenIf,g=v._thenIf,w=v.tapIf,P=r(/*! ./events */6),_=P.listen,A=r(/*! ./monads */7),E=A.chain,S=A.chainEnd,I=r(/*! ./promise */8),F=I.all,O=I.cast,j=I.reject,x=I.delay,T=e;T.prototype.all=T.all=F,T.prototype.cast=O,T.prototype.reject=j,T.prototype.delay=x,T.delay=x,T.chain=E,T.prototype.chainEnd=S,T.prototype.map=l,T.prototype.find=d,T.prototype.filter=p,T.prototype.reduce=h,T.prototype.findIndex=m,T.prototype.tapIf=w,T.prototype.thenIf=b,T.prototype._thenIf=g,T.thenIf=g,T.prototype.listen=_,T.prototype.addStep=function(t,n){return this.steps&&this.steps.push([t,this,n]),this},T.prototype.concurrency=function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:1/0;return this.steps?this.addStep("concurrency",[].concat(Array.prototype.slice.call(arguments))):(this._FP.concurrencyLimit=t,this)},T.prototype.serial=function(){return this.steps?this.addStep("serial",[].concat(Array.prototype.slice.call(arguments))):this.concurrency(1)},T.prototype.get=function(){for(var t=arguments.length,n=Array(t),r=0;r<t;r++)n[r]=arguments[r];return this.steps?this.addStep("get",[].concat(Array.prototype.slice.call(arguments))):(n=a(n),this.then(function(t){return"object"===(void 0===t?"undefined":o(t))?1===n.length?t[n[0]]:n.reduce(function(n,r){return n[r]=t[r],n},{}):t}))},T.prototype.set=function(t,n){return this.steps?this.addStep("set",[].concat(Array.prototype.slice.call(arguments))):this.then(function(r){return"object"===(void 0===r?"undefined":o(r))&&(r[t]=n),r})},T.prototype.catch=function(t){if(this.steps)return this.addStep("catch",[].concat(Array.prototype.slice.call(arguments)));if(2===arguments.length)return this.catchIf.apply(this,arguments);if(!s(t))throw new u("Invalid fn argument for `.catch(fn)`. Must be a function. Currently: "+(void 0===t?"undefined":o(t)));return T.resolve(this._FP.promise.catch(function(n){return t(n)}))},T.prototype.catchIf=function(t,n){if(this.steps)return this.addStep("catchIf",[].concat(Array.prototype.slice.call(arguments)));if(!s(n))throw new u("Invalid fn argument for `.catchIf(condition, fn)`. Must be a function. Currently: "+(void 0===n?"undefined":o(n)));return T.resolve(this._FP.promise.catch(function(r){if(t&&r instanceof t)return n(r);throw r}))},T.prototype.then=function(t){if(this.steps)return this.addStep("then",[].concat(Array.prototype.slice.call(arguments)));if(!s(t))throw new u("Invalid fn argument for `.then(fn)`. Must be a function. Currently: "+(void 0===t?"undefined":o(t)));return T.resolve(this._FP.promise.then(t))},T.prototype.tap=function(t){if(this.steps)return this.addStep("tap",[].concat(Array.prototype.slice.call(arguments)));if(!s(t))throw new u("Invalid fn argument for `.tap(fn)`. Must be a function. Currently: "+(void 0===t?"undefined":o(t)));return T.resolve(this._FP.promise.then(function(n){return t(n),n}))},T.resolve=function(t){return new T(function(n,r){if(t&&s(t.then))return t.then(n).catch(r);n(t)})},T.promisify=function(t){var n=this;return function(){for(var r=arguments.length,e=Array(r),o=0;o<r;o++)e[o]=arguments[o];return new T(function(r,o){return t.call.apply(t,[n].concat(e,[function(t,n){return t?o(t):r(n)}]))})}},T.promisifyAll=function(t){if(!t||!Object.getPrototypeOf(t))throw new Error("Invalid Argument obj in promisifyAll(obj)");return Object.getOwnPropertyNames(t).filter(function(n){return"function"==typeof t[n]}).reduce(function(t,n){return/Sync/.test(n)||t[n+"Async"]||(t[n+"Async"]=T.promisify(t[""+n])),t},t)},T.unpack=function(){var t=void 0,n=void 0,r=void 0;return r=new Promise(function(r,e){t=r,n=e}),{promise:r,resolve:t,reject:n}},t.exports=e,n&&n.on&&(n.on("uncaughtException",function(t){return console.error("Process: FATAL EXCEPTION: uncaughtException",t,"\n\n")}),n.on("unhandledRejection",function(t){return console.error("Process: FATAL PROMISE ERROR: unhandledRejection",t,"\n\n")}))}).call(n,r(/*! ./../node_modules/process/browser.js */4))},/*!*******************************!*\
