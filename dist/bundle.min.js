...
/*! all exports used */
function(t,n,r){(function(n){function e(t,n){if(!(this instanceof e))return new e(t);if(void 0!=n)throw new Error("FunctionalPromise only accepts 1 argument");this._FP={concurrencyLimit:4,hardErrorLimit:-1,promise:new Promise(t)}}function o(t){if(this.steps)return this.addStep("then",[].concat(Array.prototype.slice.call(arguments)));if(!y(t))throw new p("Invalid fn argument for `.then(fn)`. Must be a function. Currently: "+(void 0===t?"undefined":f(t)));return U.resolve(this._FP.promise.then(t))}function i(t){if(this.steps)return this.addStep("tap",[].concat(Array.prototype.slice.call(arguments)));if(!y(t))throw new p("Invalid fn argument for `.tap(fn)`. Must be a function. Currently: "+(void 0===t?"undefined":f(t)));return U.resolve(this._FP.promise.then(function(n){return t(n),n}))}function u(t){return new U(function(n,r){if(t&&y(t.then))return t.then(n).catch(r);n(t)})}function c(t){var n=this;return function(){for(var r=arguments.length,e=Array(r),o=0;o<r;o++)e[o]=arguments[o];return new U(function(r,o){return t.call.apply(t,[n].concat(e,[function(t,n){return t?o(t):r(n)}]))})}}function s(t){if(!t||!Object.getPrototypeOf(t))throw new Error("Invalid Argument obj in promisifyAll(obj)");return Object.getOwnPropertyNames(t).filter(function(n){return"function"==typeof t[n]}).reduce(function(t,n){return/Sync/.test(n)||t[n+"Async"]||(t[n+"Async"]=c(t[""+n])),t},t)}function a(){var t=void 0,n=void 0,r=void 0;return r=new Promise(function(r,e){t=r,n=e}),{promise:r,resolve:t,reject:n}}var f="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},l=r(/*! ./modules/errors */1),p=l.FunctionalError,h=r(/*! ./modules/utils */2),y=h.isFunction,d=r(/*! ./arrays */3),m=d.map,v=d.filter,b=r(/*! ./arrays */3),g=b.reduce,w=r(/*! ./arrays */3),P=w.find,_=w.findIndex,E=r(/*! ./conditional */4),A=E.thenIf,S=E._thenIf,I=r(/*! ./conditional */4),F=I.tapIf,O=r(/*! ./events */7),j=O.listen,x=r(/*! ./monads */8),T=x.chain,L=x.chainEnd,M=r(/*! ./promise */5),R=M.all,k=M.cast,C=r(/*! ./promise */5),N=C.reject,q=C.delay,U=e;U.denodeify=U.promisify=c,U.promisifyAll=s,U.resolve=u,U.prototype.all=U.all=R,U.prototype.cast=k,U.prototype.reject=N,U.prototype.tap=i,U.prototype.then=o,U.prototype.delay=q,U.delay=q,U.chain=T,U.prototype.chainEnd=L,U.prototype.map=m,U.prototype.find=P,U.prototype.filter=v,U.prototype.reduce=g,U.prototype.findIndex=_,U.prototype.tapIf=F,U.prototype.thenIf=A,U.prototype._thenIf=S,U.thenIf=S,U.prototype.listen=j,U.unpack=a,U.prototype.addStep=function(t,n){return this.steps&&this.steps.push([t,this,n]),this},U.prototype.concurrency=function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:1/0;return this.steps?this.addStep("concurrency",[].concat(Array.prototype.slice.call(arguments))):(this._FP.concurrencyLimit=t,this)},U.prototype.serial=function(){return this.steps?this.addStep("serial",[].concat(Array.prototype.slice.call(arguments))):this.concurrency(1)},U.prototype.get=function(t){return this.steps?this.addStep("get",[].concat(Array.prototype.slice.call(arguments))):this.then(function(n){return"object"===(void 0===n?"undefined":f(n))?n[t]:n})},U.prototype.set=function(t,n){return this.steps?this.addStep("set",[].concat(Array.prototype.slice.call(arguments))):this.then(function(r){return"object"===(void 0===r?"undefined":f(r))&&(r[t]=n),r})},U.prototype.catch=function(t){if(this.steps)return this.addStep("catch",[].concat(Array.prototype.slice.call(arguments)));if(2===arguments.length)return this.catchIf.apply(this,arguments);if(!y(t))throw new p("Invalid fn argument for `.catch(fn)`. Must be a function. Currently: "+(void 0===t?"undefined":f(t)));return U.resolve(this._FP.promise.catch(function(n){return t(n)}))},U.prototype.catchIf=function(t,n){if(this.steps)return this.addStep("catchIf",[].concat(Array.prototype.slice.call(arguments)));if(!y(n))throw new p("Invalid fn argument for `.catchIf(condition, fn)`. Must be a function. Currently: "+(void 0===n?"undefined":f(n)));return U.resolve(this._FP.promise.catch(function(r){if(t&&r instanceof t)return n(r);throw r}))},t.exports=e,n&&n.on&&(n.on("uncaughtException",function(t){console.error("Process: FATAL EXCEPTION: uncaughtException",t,"\n\n")}),n.on("unhandledRejection",function(t){console.error("Process: FATAL PROMISE ERROR: unhandledRejection",t,"\n\n")}))}).call(n,r(/*! ./../node_modules/process/browser.js */6))},/*!*******************************!*\
